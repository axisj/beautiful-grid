---
title: "Ant Design 에디터 플러그인 (Ant Design Editor Plugins)"
description: "Ant Design과 앱 전용 입력 컴포넌트를 plugin으로 연결하고 popup portal, 다중 변경 commit, 종료 수명주기를 관리하는 방법을 설명합니다."
category: "interaction"
order: 4
locale: "ko"
canonicalPath: "/plugins/antd"
demoId: "editor-plugins-antd"
features: ["editor-plugin", "defineEditorPlugin", "portal", "commit", "lifecycle"]
relatedGuides: ["editor-plugins", "editor-plugins-shadcn", "editor-plugins-mui", "editor-plugins-mantine", "built-in-editors"]
