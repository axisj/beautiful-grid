...
const typeMetadata: Record<string, { group: string; summary: string }> = {
  ...
  BGridColumnVisibilityChangeEvent: { group: 'query', summary: 'v1.0.6부터 컬럼 숨김, 표시 또는 전체 표시 동작을 설명합니다.' },
  BGridColumnVisibilityOptions: { group: 'query', summary: 'v1.0.6부터 controlled 또는 uncontrolled 컬럼 숨김 상태를 설정합니다.' },
...
const memberDescriptions: Record<string, string> = {
  ...
  hideable: 'v1.0.6부터 사용자가 툴박스에서 이 컬럼을 숨길 수 있는지 설정합니다.',
  columnVisibility: 'v1.0.6부터 컬럼 숨김과 복구 UI 및 상태 제어를 활성화합니다.',
  hiddenColumnIds: '숨길 컬럼의 고유 id 목록입니다.',
  defaultHiddenColumnIds: 'uncontrolled 모드에서 처음 숨길 컬럼 id 목록입니다.',
